...
class AdminController extends Controller
{
    ...
    {   
        if(Auth::user()->isAdm()){   
            ...
            return view('hrms.admin.add_adm', compact('roles','city_list','zone_list','unit_list') );
        }else{
    ...
    {     
        ...
        ->paginate(10);   
            ...
            return view('hrms.admin.show_adm', compact('emps'));
    ...
    {   
        ...
        return view('hrms.admin.add_adm', compact('emps', 'roles','city_list','zone_list','unit_list'));
    }
