...
Route::post('/import','UploadFileController@import');  
Route::get('/export', 'UploadFileController@exportCsv');
...
//    Route::post('edit-project/{projectId}', 'ProjectController@saveProjectEdit');
    ...
    Route::get('add-zone', ['as' => 'add-zone', 'uses' => 'ZoneController@addZone']);
    Route::post('add-zone', ['as' => 'add-zone', 'uses' => 'ZoneController@processZone']);
    Route::get('zone-list', ['as' => 'zone-list', 'uses' => 'ZoneController@showZone']);
    Route::get('edit-zone/{id}', ['as' => 'edit-zone', 'uses' => 'ZoneController@showEdit']);
    Route::post('edit-zone/{id}', ['as' => 'edit-zone', 'uses' => 'ZoneController@doEdit']);
    Route::get('delete-zone/{id}', ['as' => 'delete-zone', 'uses' => 'ZoneController@doDelete']);

    //Routes for city.
    Route::get('add-city', ['as' => 'add-city', 'uses' => 'CityController@addCity']);
    Route::get('add-city', ['as' => 'add-city', 'uses' => 'CityController@showZoneAll']);
    Route::post('add-city', ['as' => 'add-city', 'uses' => 'CityController@processCity']);
    Route::get('city-list', ['as' => 'city-list', 'uses' => 'CityController@showCity']);
    Route::get('edit-city/{id}', ['as' => 'edit-city', 'uses' => 'CityController@showEdit']);
    Route::post('edit-city/{id}', ['as' => 'edit-city', 'uses' => 'CityController@doEdit']);
    Route::get('delete-city/{id}', ['as' => 'delete-city', 'uses' => 'CityController@doDelete']);

    //Routes for employee management.

    Route::get('add-emp', ['as' => 'add-emp', 'uses' => 'EmpController@addEmp']);
    Route::post('add-emp', ['as' => 'add-emp', 'uses' => 'EmpController@processEmp']);
    Route::get('emp-list', ['as' => 'emp-list', 'uses' => 'EmpController@showEmp']);
    Route::get('edit-emp/{id}', ['as' => 'edit-emp', 'uses' => 'EmpController@showEdit']);
    Route::post('edit-emp/{id}', ['as' => 'edit-emp', 'uses' => 'EmpController@doEdit']);
    Route::post('get_city/{id}', ['as' => 'get_city', 'uses' => 'EmpController@get_city']);
    Route::get('get_city/{id}', ['as' => 'get_city', 'uses' => 'EmpController@get_city']);
    Route::post('get_unit/{id}/{uid}', ['as' => 'get_unit', 'uses' => 'EmpController@get_unit']);
    Route::get('get_unit/{id}/{uid}', ['as' => 'get_unit', 'uses' => 'EmpController@get_unit']);
    //Route::get('delete-emp/{id}', ['as' => 'delete-emp', 'uses' => 'EmpController@doDelete']);

    //Routes for unit.

    Route::get('add-unit', ['as' => 'add-unit', 'uses' => 'UnitController@addUnit']);
    Route::post('add-unit', ['as' => 'add-unit', 'uses' => 'UnitController@processUnit']);
    Route::get('unit-list', ['as' => 'unit-list', 'uses' => 'UnitController@showUnit']);
    Route::get('edit-unit/{id}', ['as' => 'edit-unit', 'uses' => 'UnitController@showEdit']);
    Route::post('edit-unit/{id}', ['as' => 'edit-unit', 'uses' => 'UnitController@doEdit']);
    Route::get('delete-unit/{id}', ['as' => 'delete-unit', 'uses' => 'UnitController@doDelete']);

    //Routes for siteinfo.

    Route::get('add-siteinfo', ['as' => 'add-siteinfo', 'uses' => 'SiteinfoController@addSiteinfo']);
    Route::post('add-siteinfo', ['as' => 'add-siteinfo', 'uses' => 'SiteinfoController@processSiteinfo']);
    Route::get('siteinfo-list', ['as' => 'siteinfo-list', 'uses' => 'SiteinfoController@showSiteinfo']);
    Route::get('view-siteinfo/{id}', ['as' => 'view-siteinfo', 'uses' => 'SiteinfoController@viewSiteinfo']);
    Route::get('edit-siteinfo/{id}', ['as' => 'edit-siteinfo', 'uses' => 'SiteinfoController@showEdit']);
    Route::post('edit-siteinfo/{id}', ['as' => 'edit-siteinfo', 'uses' => 'SiteinfoController@doEdit']);
    Route::get('delete-siteinfo/{id}', ['as' => 'delete-siteinfo', 'uses' => 'SiteinfoController@doDelete']);

    //Routes for user.
    Route::get('add-user', ['as' => 'add-user', 'uses' => 'UserController@addUser']);
    Route::post('add-user', ['as' => 'add-user', 'uses' => 'UserController@processUser']);
    Route::get('user-list', ['as' => 'user-list', 'uses' => 'UserController@showUser']);    
    Route::get('edit-user/{id}', ['as' => 'edit-user', 'uses' => 'UserController@showEdit']);
    Route::post('edit-user/{id}', ['as' => 'edit-user', 'uses' => 'UserController@doEdit']);
    Route::get('edit-user-report/{id}', ['as' => 'edit-user-report', 'uses' => 'UserController@showEditReport']);
    Route::post('edit-user-report/{id}', ['as' => 'edit-user-eport', 'uses' => 'UserController@doEditReport']);
    Route::post('get_city/{id}', ['as' => 'get_city', 'uses' => 'UserController@get_city']);
    Route::get('get_city/{id}', ['as' => 'get_city', 'uses' => 'UserController@get_city']);
    Route::post('get_unit/{id}/{uid}', ['as' => 'get_unit', 'uses' => 'UserController@get_unit']);
    Route::get('get_unit/{id}/{uid}', ['as' => 'get_unit', 'uses' => 'UserController@get_unit']);
    Route::get('delete-user/{id}', ['as' => 'delete-user', 'uses' => 'UserController@doDelete']);
    
    //Routes for admin.
    Route::get('add-admin', ['as' => 'add-admin', 'uses' => 'AdminController@addAdmin']);
    Route::post('add-admin', ['as' => 'add-admin', 'uses' => 'AdminController@processAdmin']);
    Route::get('admin-list', ['as' => 'admin-list', 'uses' => 'AdminController@showAdmin']);
    Route::get('edit-admin/{id}', ['as' => 'edit-admin', 'uses' => 'AdminController@showEdit']);
    Route::post('edit-admin/{id}', ['as' => 'edit-admin', 'uses' => 'AdminController@doEdit']);
    Route::post('get_city/{id}', ['as' => 'get_city', 'uses' => 'AdminController@get_city']);
    Route::get('get_city/{id}', ['as' => 'get_city', 'uses' => 'AdminController@get_city']);
    Route::post('get_unit/{id}/{uid}', ['as' => 'get_unit', 'uses' => 'AdminController@get_unit']);
    Route::get('get_unit/{id}/{uid}', ['as' => 'get_unit', 'uses' => 'AdminController@get_unit']);
    //Route::get('delete-admin/{id}', ['as' => 'delete-admin', 'uses' => 'EmpController@doDelete']);

    //Routes for Qualitycheck.   
    Route::get('report-listing', ['as' => 'report-listing', 'uses' => 'QualityCheckController@showReport']);
    Route::get('edit-report/{id}', ['as' => 'edit-report', 'uses' => 'QualityCheckController@showEditReport']);
    Route::post('edit-report/{id}', ['as' => 'edit-report', 'uses' => 'QualityCheckController@doEditReport']);    
