...
<div class="content">
    ...
    <div class="container-fluid">       
        <div class="page-title-box">
            <h4 class="page-title">Admin <span class="page-title-right"><a href="/add-admin" class="btn btn-success rounded-pill waves-effect waves-light">Create user </a></span></h4>
        </div>       
    </div>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="card p-4">
                        <div class="panel-heading">
                            <span class="panel-title hidden-xs"> Admin Lists </span>
                        </div>
                        <div class="card-body">
                                    ...
                                    <td class="text-right">
                                        <div class="btn-group text-right">
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                <li>
                                                    <a href="/edit-admin/{{$val->id}}">Edit</a>
                                                </li>
                                                <li>
                                                    <a href="#">Delete</a>
                                                </li>
